...
- MOSE TinyImageNet 10k



- MOSE TinyImageNet 4k

```
total 5runs last test acc results: tensor([27.7100, 28.7600, 28.3700, 27.8600, 27.1800])
----------- Avg_End_Acc (27.976, 0.7572420003843195) Avg_End_Fgt (29.471999999999998, 0.7553971914027859) Avg_Acc (43.06254180349907, 0.5101566919139079) Avg_Bwtp (0.0, 0.0) Avg_Fwt (0.0, 0.0)-----------
====================================================================================================

====================================================================================================
total 5runs test acc results: tensor([29.5200, 30.5600, 29.9800, 29.5500, 29.5400])
----------- Avg_End_Acc (29.830000000000002, 0.5601267268061718) Avg_End_Fgt (26.297999999999995, 0.470638157217228) Avg_Acc (44.1666208460049, 0.5755224510136177) Avg_Bwtp (0.0, 0.0) Avg_Fwt (0.0, 0.0)-----------
```

- MOSE TinyImageNet 2k


```
total 5runs last test acc results: tensor([19.0400, 19.4600, 18.4700, 18.5000, 18.7100])
----------- Avg_End_Acc (18.836000000000002, 0.5170900738610494) Avg_End_Fgt (46.263999999999996, 1.0012386142495713) Avg_Acc (36.182702704561784, 0.4339487644050027) Avg_Bwtp (0.0, 0.0) Avg_Fwt (0.0, 0.0)-----------
====================================================================================================

====================================================================================================
total 5runs test acc results: tensor([21.4100, 21.8700, 21.1600, 20.9600, 21.2800])
----------- Avg_End_Acc (21.336000000000002, 0.42386051576108497) Avg_End_Fgt (40.898, 0.6471797656266411) Avg_Acc (37.85177189462769, 0.3908659759903025) Avg_Bwtp (0.0, 0.0) Avg_Fwt (0.0, 0.0)-----------
```

- MOSE TinyImageNet 10k

```
total 5runs last test acc results: tensor([39.0000, 38.1800, 38.7000, 38.5300, 38.6400])
----------- Avg_End_Acc (38.61, 0.3685462896011242) Avg_End_Fgt (15.458000000000002, 0.300113039504641) Avg_Acc (48.69704314134275, 0.2715726915080529) Avg_Bwtp (0.0, 0.0) Avg_Fwt (0.0, 0.0)-----------
====================================================================================================

====================================================================================================
total 5runs test acc results: tensor([40.1600, 38.7300, 38.7200, 38.8300, 39.0700])
----------- Avg_End_Acc (39.102, 0.7549378375145992) Avg_End_Fgt (13.904000000000002, 0.6605722488719462) Avg_Acc (48.921606058086596, 0.27219871391145267) Avg_Bwtp (0.0, 0.0) Avg_Fwt (0.0, 0.0)-----------
```
