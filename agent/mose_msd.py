...
class MOSE_MSD(object):
            ...
            if len(self.buffer) > 0:
                ...
                with autocast():
                    ...
                    if task_id > 0:
                        ...
                        stu_feat = feat_list[-1]
                        stu_feat = self.model.final_addaption_layer(stu_feat)

                        feat_list, proj_list, pred_list = \
                            self.select_expert_output(feat_list, proj_list, pred_list)
    ...
    def select_expert_output(self, feat_list, proj_list, pred_list):
        ...
        elif self.n_experts == 2:
            feat_list = [feat_list[1], feat_list[-1]]
            proj_list = [proj_list[1], proj_list[-1]]
            pred_list = [pred_list[1], pred_list[-1]]

        elif self.n_experts == 3:
            feat_list = [feat_list[1], feat_list[3], feat_list[-1]]
            proj_list = [proj_list[1], proj_list[3], proj_list[-1]]
            pred_list = [pred_list[1], pred_list[3], pred_list[-1]]

        elif self.n_experts == 4:
            feat_list = [feat_list[1], feat_list[3], feat_list[5], feat_list[-1]]
            proj_list = [proj_list[1], proj_list[3], proj_list[5], proj_list[-1]]
            pred_list = [pred_list[1], pred_list[3], pred_list[5], pred_list[-1]]

        elif self.n_experts == 5:
            feat_list = [feat_list[0], feat_list[1], feat_list[3], feat_list[5], feat_list[-1]]
            proj_list = [proj_list[0], proj_list[1], proj_list[3], proj_list[5], proj_list[-1]]
            pred_list = [pred_list[0], pred_list[1], pred_list[3], pred_list[5], pred_list[-1]]

        elif self.n_experts == 6:
            feat_list = [feat_list[0], feat_list[1], feat_list[2], feat_list[3], feat_list[5], feat_list[-1]]
            proj_list = [proj_list[0], proj_list[1], proj_list[2], proj_list[3], proj_list[5], proj_list[-1]]
            pred_list = [pred_list[0], pred_list[1], pred_list[2], pred_list[3], pred_list[5], pred_list[-1]]

        elif self.n_experts == 7:
            feat_list = [feat_list[0], feat_list[1], feat_list[2], feat_list[3], feat_list[4], feat_list[5], feat_list[-1]]
            proj_list = [proj_list[0], proj_list[1], proj_list[2], proj_list[3], proj_list[4], proj_list[5], proj_list[-1]]

        return feat_list, proj_list, pred_list
